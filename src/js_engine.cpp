...
const JSCFunctionListEntry kStyleProto[] = {
    ...
    JS_CGETSET_MAGIC_DEF("justifyItems", JsStyleGetProperty, JsStyleSetProperty, 31),
    JS_CGETSET_MAGIC_DEF("gridAutoFlow", JsStyleGetProperty, JsStyleSetProperty, 32),
